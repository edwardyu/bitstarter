function xkcdplot() {
    ...
    var xkcd = function (nm) {
        el = d3.select("#drawhere").append("svg")
    ...
    xkcd.draw = function () {
        ...
        el.append("text").attr("class", "x label xk")
                              .attr("text-anchor", "end")
                              .attr("x", width - s)
                              .attr("y", y0 + aa)
                              .attr("dy", ".75em")
                              .text(xlabel);
        el.append("text").attr("class", "y label xk")
                              .attr("text-anchor", "end")
                              .attr("x", aa)
                              .attr("y", x0)
                              .attr("dy", "-.75em")
        ...
        // And a title.
        el.append("text").attr("class", "title xk")
                              .attr("text-anchor", "end")
                              .attr("x", width)
                              .attr("y", 0)
                              .text(title);
